...
export default function CDropdown({ text, innerText }) {
  ...
  return (
    <div className="py-[26px] border-b [border-image:linear-gradient(90deg,rgba(255,255,255,0)_0%,rgba(255,255,255,0.4)_45.76%,rgba(255,255,255,0)_100%)_1] w-[calc(100%_-_48px)] flex justify-between items-center">
      ...
      <div onClick={ toggleExpanded } className="size-[40px] sm:size-[80px] flex justify-center items-center shadow-[inset_0px_-3px_4px_rgba(168,162,255,0.5),inset_0px_3px_4px_rgba(168,162,255,0.5)] backdrop-blur-[127px] rounded-full cursor-pointer ml-[16px] shrink-0 self-start">
        { isExpanded
